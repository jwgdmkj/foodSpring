...
public class MemberConfig {
	...
	public DataSource dataSource() {
		...
		ds.setUrl("jdbc:mysql://nutri.ck6rohqrjhzp.ap-northeast-2.rds.amazonaws.com:3306/foodvar?characterEncoding=utf8");
		ds.setUsername("root");
		ds.setPassword("dkcmrl1011");
		ds.setInitialSize(2);
		ds.setMaxActive(10);
